...
Repeat with `g1_29` and its URDF. No controller or exoskeleton ports are configured:
this is a supported-arm posture/view check, not locomotion or keyboard Cartesian control.
